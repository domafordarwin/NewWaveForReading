...
| --- | --- | --- |
| scores.book_analysis | evaluations.book_analysis_score | 0~25 |
| scores.creative_thinking | evaluations.creative_thinking_score | 0~25 |
| scores.problem_solving | evaluations.problem_solving_score | 0~25 |
| scores.language_expression | evaluations.language_expression_score | 0~25 |
| total_score | evaluations.total_score | 0~100 |
...
| feedback_summary | evaluations.overall_comment | 요약 |
...
| corrections[*].position.start | corrections.start_index | 컬럼 필요 |
| corrections[*].position.end | corrections.end_index | 컬럼 필요 |
| corrections[*].original | corrections.original_text | 컬럼 필요 |
| corrections[*].suggested | corrections.suggested_text | 컬럼 필요 |
| corrections[*].reason | corrections.reason | 컬럼 필요 |
| corrections | feedbacks.line_edits | jsonb 가능 |
...
- GET /answers/assessment/{assessmentId}
- POST /answers/{answerId}/analyze

### Evaluation
- GET /evaluations
- GET /evaluations/{evaluationId}
- GET /evaluations/answer/{answerId}
- GET /evaluations/student/{studentId}

### Correction
- GET /corrections/{correctionId}
- GET /corrections/evaluation/{evaluationId}

---

## 11. 프론트 연동 API (api.ts 반영)
- evaluation 응답 normalize 처리 (evaluation + corrections)
- 학생별 평가 조회 API 연결
- 첨삭 조회 함수 추가
- 답안 전체 조회/수정 함수 추가
...
| 구분 | 경로 |
| --- | --- |
| Service | backend/src/main/java/com/literacy/assessment/service/AnswerService.java |
| Service | backend/src/main/java/com/literacy/assessment/service/EvaluationService.java |
| Service | backend/src/main/java/com/literacy/assessment/service/CorrectionService.java |
| Repository | backend/src/main/java/com/literacy/assessment/repository/EvaluationRepository.java |
| Controller | backend/src/main/java/com/literacy/assessment/controller/AnswerController.java |
| Controller | backend/src/main/java/com/literacy/assessment/controller/EvaluationController.java |
| Controller | backend/src/main/java/com/literacy/assessment/controller/CorrectionController.java |
