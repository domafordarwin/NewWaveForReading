...
alter table public.authoring_items
  drop constraint if exists fk_authoring_items_current_version;

alter table public.authoring_items
  add constraint fk_authoring_items_current_version
  foreign key (current_version_id)
  references public.authoring_item_versions(version_id)
  on delete set null;
...
alter table public.authoring_rubrics
  drop constraint if exists fk_authoring_rubrics_current_version;

alter table public.authoring_rubrics
  add constraint fk_authoring_rubrics_current_version
  foreign key (current_version_id)
  references public.authoring_rubric_versions(version_id)
  on delete set null;
