...
values
  ...
  (3, 3, 5, 3,
    ...
    array['반례 추가'],
    '근거 다양성 보강 필요.',
    'COMPLETED', '2024-12-17T12:10:00Z'),
  (4, 4, 6, 4,
    '창의적 관점이 돋보입니다.',
    ...
    array['사례 구체화'],
    '강점 유지 권장.',
    'COMPLETED', '2024-12-16T12:10:00Z'),
  (5, 5, 7, 5,
    '핵심 요약이 좋습니다.',
    '근거가 부족합니다. 사례를 보강하세요.',
    '마무리를 더 명확히 해보세요.',
    ...
    array['사례 보강'],
    '근거 보강 필요.',
    'COMPLETED', '2024-12-15T12:10:00Z'),
  (6, 6, 8, 6,
    '관계의 의미를 잘 설명했습니다.',
    '근거 흐름이 안정적입니다.',
    '어휘 다양성을 높여보세요.',
    ...
    array['어휘 확장'],
    '표현력 보강 필요.',
    'COMPLETED', '2024-12-14T12:10:00Z'),
  (7, 7, 9, 7,
    '분석력이 뛰어납니다.',
    '근거와 흐름이 매우 좋습니다.',
    '사례를 조금 더 구체화하면 좋습니다.',
    ...
    array['사례 구체화'],
    '강점 유지 권장.',
    'COMPLETED', '2024-12-13T12:10:00Z'),
  (8, 8, 10, 8,
    '핵심 개념 연결이 적절합니다.',
    '근거 다양성이 부족합니다.',
    '반례를 추가해보세요.',
    ...
    array['반례 추가'],
    '근거 보강 필요.',
    'COMPLETED', '2024-12-12T12:10:00Z'),
  (9, 9, 11, 9,
    '본질적 메시지를 잘 연결했습니다.',
    '근거 흐름이 안정적입니다.',
    '경험을 조금 더 구체화해보세요.',
    ...
    array['경험 구체화'],
    '표현 보강 권장.',
    'COMPLETED', '2024-12-11T12:10:00Z'),
  (10, 10, 12, 10,
    '논리 전개가 매우 안정적입니다.',
    '근거와 흐름이 좋습니다.',
    ...
    array['문장 간결화'],
    '간결한 표현 연습 필요.',
    'COMPLETED', '2024-12-10T12:10:00Z');
