      ...
      <Box component="section" sx={{ mb: 6 }}>
        ...
        <Paper sx={{ p: 3, border: "1px solid #FCD6B5", bgcolor: "#FFF4E5", mb: 4 }}>
          ...
          <Typography sx={{ mt: 2, color: "#7C2D12", lineHeight: 1.8 }}>
            ...
            개인별 읽기 성향을 파악하는 평가도구입니다. 단순한 독해 능력뿐만 아니라
            책을 대하는 마음가짐, 선호하는 책의 종류, 읽기 동기와 목적, 독서 습관 및
            환경 등 비인지적 특성을 함께 살펴봅니다.
          </Typography>
          <Typography sx={{ mt: 2, color: "#7C2D12", lineHeight: 1.8 }}>
            이를 통해 학생 개개인의 강점과 약점을 진단하고, 그 결과를 바탕으로
            맞춤형 독서 지도를 제공하는 것이 목적입니다.
          </Typography>
        </Paper>
