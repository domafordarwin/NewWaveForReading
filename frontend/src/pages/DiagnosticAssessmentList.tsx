...
export default function DiagnosticAssessmentList() {
  ...
  const handlePublish = async (assessmentId: number) => {
    if (
      !confirm(
        "이 평가를 배포하시겠습니까? 배포 후에는 학생들이 응시할 수 있습니다.",
      )
    ) {
      return;
    }
    ...
    <Box sx={{ p: 3 }}>
      ...
      >
        ...
        <Button
          ...
          startIcon={<Add />}
          onClick={() =>
            navigate("/question-dev/diagnostic-assessments/create")
          }
        >
          새 평가 생성
        </Button>
                ...
                <TableRow key={assessment.assessment_id} hover>
                  ...
                  <TableCell align="center">
                    <IconButton
                      ...
                      onClick={() =>
                        navigate(
                          `/question-dev/diagnostic-assessments/${assessment.assessment_id}`,
                        )
                      }
                      title="상세 보기"
                    >
                    ...
                    <IconButton
                      ...
                      onClick={() =>
                        navigate(
                          `/question-dev/diagnostic-assessments/${assessment.assessment_id}/edit`,
                        )
                      }
                      title="수정"
